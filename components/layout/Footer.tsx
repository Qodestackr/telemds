...
export default function Footer() {
  ...
  return isDashboardPage ? null : (
    <footer className="bg-[#FAFBFC] mt-4 md:mt-8 w-full max-w-[85rem] py-10 px-4 sm:px-6 lg:px-8 mx-auto">
          ...
          <div className="mt-3 grid space-y-3 text-sm">
            <p>
              <Link
                ...
                href="/types-of-care/urgent-care-a&e-at-home"
              >
                Acute & Urgent Care
              </Link>
            </p>
            <p>
              <Link
                className="inline-flex gap-x-2 text-gray-600 hover:text-gray-800 dark:text-gray-400 dark:hover:text-gray-200 dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600"
                href="/types-of-care/chronic-diseases-management"
              >
                Chronic Care
              </Link>
            </p>
            ...
            <p>
              <Link
                className="inline-flex gap-x-2 text-gray-600 hover:text-gray-800 dark:text-gray-400 dark:hover:text-gray-200 dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600"
                href="/types-of-care/babyvaccinations"
              >
                Home-based Baby Vaccinations
              </Link>
            </p>
            ...
            <p>
              <Link
                className="inline-flex gap-x-2 text-gray-600 hover:text-gray-800 dark:text-gray-400 dark:hover:text-gray-200 dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600"
                href="/types-of-care/health-screening"
              >
                Health Screening
              </Link>
            </p>
            <p>
              <Link
                className="inline-flex gap-x-2 text-gray-600 hover:text-gray-800 dark:text-gray-400 dark:hover:text-gray-200 dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600"
                href="/types-of-care/h-programme"
              >
                Home-Programme
              </Link>
            </p>
        ...
        <div>
          ...
          <div className="mt-3 grid space-y-3 text-sm">
            ...
            <p>
              <Link
                className="inline-flex gap-x-2 text-gray-600 hover:text-gray-800 dark:text-gray-400 dark:hover:text-gray-200 dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600"
                href="/afyamed-hospital-care-at-home"
              >
        ...
        <div>
          ...
          <div className="mt-3 grid space-y-3 text-sm">
            ...
            <p>
              ...
              {/* <span className="inline text-meta-3">— transforming healthcare for everyone</span> */}
            </p>
        ...
        <div>
          ...
          <div className="mt-3 grid space-y-3 text-sm">
            <p>
              <Link
                className="inline-flex gap-x-2 text-gray-600 hover:text-gray-800 dark:text-gray-400 dark:hover:text-gray-200 dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600"
                href="/afyamed-ecosystem"
              >
                AfyaMed APIs & Ecosystem
              </Link>
            </p>
            <p>
              <Link
